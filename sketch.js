...
var pathImg,boyImg,boyImgc,cashImg,diamondsImg,jewelryImg,swordImg;
...
function preload(){
  ...
  boyImg = loadImage("biker.png");
  boyImgc = loadImage("biker2.png");
  cashImg = loadImage("cash.png");
  diamondsImg = loadImage("diamonds.png");
  jewelryImg = loadImage("jwell.png");
  swordImg = loadImage("obstacle.png");
...
boy.addImage(boyImg);
boy.scale=0.4;
boy.setCollider("circle",0,-190,50);  
boy.debug = true;
